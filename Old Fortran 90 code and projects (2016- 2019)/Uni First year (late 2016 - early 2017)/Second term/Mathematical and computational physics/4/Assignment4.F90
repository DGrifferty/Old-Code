...
DO WHILE (Mainloop=='Y' .OR. Mainloop=='y')
  ...
  ELSE IF (Main=='t' .or. Main=='T') THEN
    ...
    DO
      ...
      WRITE(6,*) 'Please enter the Array that you want to translate, x then y.'
      READ(5,*) Array(1,1), Array(2,1)
      WRITE(6,*) 'Please enter the amount you want to translate x by.'
      READ(5,*) Xtranslation
      WRITE(6,*) 'Please enter the amount you want to translate y by.'
      READ(5,*) Ytranslation
      WRITE(6,*) 'You entered', Array(1,1), Array(2,1), 'as the Array, and', Xtranslation
    ...
    END DO
      ...
      WRITE(6,*)'Your trasnlated array is:'
