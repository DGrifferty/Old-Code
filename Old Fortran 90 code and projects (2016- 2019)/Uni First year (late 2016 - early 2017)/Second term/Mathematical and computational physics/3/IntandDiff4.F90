...
REAL(KIND = DP) :: ItrapeziumRuleTwo, ERROR, ErrorCD, ErrorFD
...
DO WHILE (Fig=='y' .or. Fig=='Y')
  ...
  IF (FigIntDiffChoice=='D' .or. FigIntDiffChoice=='d') THEN
    ...
    DO WHILE(Rerun=='Y'.or. Rerun=='y')
      ...
      DO
        READ(5,*) ReRun
        IF (ReRun/= 'Y' .and. ReRun /= 'y' .and. ReRun /= 'N' .and. IReRun /= 'n') THEN
          WRITE(6,*) 'Invalid option, try again.'
          CYCLE
        ELSE 
          EXIT
  ...
  ELSE IF (FigIntDiffChoice=='i' .OR. FigIntDiffChoice=='I') THEN 
    ...
    DO WHILE(Rerun=='Y'.or. Rerun=='y')
      ...
      DO
        ...
        READ(5,*) A 
        WRITE(6,*) 'You entered', A,'as the upper limit and', B, 'as the lower limit. Is this correct? Type Y for yes or N for no.'
        DO
      ...
      WRITE(6,*) ISimpson(A, B, N)
    
      WRITE(6,*)'Would you like to try this again with different limits? Type Y for yes and N for no.'
        DO
          READ(5,*) ReRun
  ...
  END DO
END DO
WRITE(6,*)'Thank you for using my program.'
