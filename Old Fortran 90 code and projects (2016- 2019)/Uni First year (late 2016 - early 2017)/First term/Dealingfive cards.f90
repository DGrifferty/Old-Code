...
Character(len=3), Dimension(1:5) :: o, l, k, g
...
Write (6,*) name1,'''s cards are ', o(1),' ,', o(2),' ,', o(3),' ,', o(4),' ,', o(5)
...
Write (6,*) name2,'''s cards are ', l(1),' ,', l(2),' ,', l(3),' ,', l(4),' ,', l(5)
 f=0
...
Write (6,*)name3,'''s cards are ', k(1),' ,', k(2),' ,', k(3),' ,', k(4),' ,', k(5)
 f=0
...
Write (6,*)name4,'''s cards are ', g(1),' ,', g(2),' ,', g(3),' ,', g(4),' ,', g(5)
 f=0
