...
F_new = 11+f
f=F_new
else if (l(q) == 'KiC' .or. l(q) == 'KiS' .or. l(q) == 'KiH' .or. l(q) == 'KiD')then
...
F_new = 11+f
f=F_new
else if (g(q) == 'KiC' .or. g(q) == 'KiS' .or. g(q) == 'KiH' .or. g(q) == 'KiD')then
...
Write (6,*) 'Would you like to try again? Type Y for yes, or N for no'
Read (5,*) figs

end do

end program dealingsixcards